...
import com.minimart.BUS.ChiTietHoaDonBUS;
...
public class PrintPDF {
    ...
    public void printBill(HoaDon hoaDon) throws DocumentException, IOException {
        ...
        table.setWidths(new int[]{30, 10,10,10});
        ...
        tableTotal.addCell(new Phrase());
        tableTotal.addCell(new Phrase());
        tableTotal.addCell(""+hoaDon.getTongTienKhuyenMai());
        tableTotal.addCell(new Phrase("Tiền Phải Trả: ",new Font(font,12)));
        tableTotal.addCell(new Phrase());
        tableTotal.addCell(new Phrase());
        tableTotal.addCell(""+hoaDon.getTienConLai());
