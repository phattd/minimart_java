...
public class KhuyenMaiDAO {
    ...
    public ArrayList<KhuyenMai> readDB() throws IOException {
    ...
    public ArrayList<KhuyenMai> search(String columnName, String value) throws IOException {
        kmConnection = new ConnectSQL();
        ArrayList<KhuyenMai> dssp = new ArrayList<>();
    ...
    public boolean add(KhuyenMai km) throws IOException {
        kmConnection = new ConnectSQL();
    ...
    public boolean delete(String idDotKhuyenMai) throws IOException {
        kmConnection = new ConnectSQL();
    ...
    public boolean update(String idDotKhuyenMai, String tenDotKhuyenMai, LocalDate ngayBatDau, LocalDate ngayKetThuc) throws IOException {
        kmConnection = new ConnectSQL();
